/**
 * POST /api/sophie-list-drafts
 * Header: X-Internal-Secret
 * Body: { status?, limit? }
 *
 * Liste les drafts Sophie (par défaut : status=pending_yves_approval).
...
const COLLECTION_EMAILS = "sophieEmails";
