/**
 * GET /api/sophie-modify?draft=<id>&exp=<iso>&token=<hmac>
 *
 * Bouton "Modifier" dans la notif email → redirige vers le dashboard
 * Sophie avec le draft déjà ouvert pour édition.
 *
...
<a class="btn" href="/sophie-admin.html">Ouvrir le dashboard Sophie</a>
  ...
  const target = `/sophie-admin.html?edit=${encodeURIComponent(draftId)}`;
