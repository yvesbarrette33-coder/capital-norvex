/**
 * GET /api/camille-modify?draft=<id>&exp=<iso>&token=<hmac>
 *
 * Bouton "Modifier" dans la notif email → redirige vers le dashboard
 * Camille avec le draft déjà ouvert pour édition.
 *
...
<a class="btn" href="/camille-admin.html">Ouvrir le dashboard Camille</a>
  ...
  const target = `/camille-admin.html?edit=${encodeURIComponent(draftId)}`;
